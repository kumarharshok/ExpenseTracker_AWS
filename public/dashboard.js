...
leaderboardContainer.innerHTML = "";
        axios.get(`${API_URL}`)
            .then((res) => {
                ...
                const leaderboardContainer = document.getElementById('leaderboard-container');
leaderboardContainer.innerHTML = ""; 
leaderboardContainer.appendChild(containerDiv)
        ...
        <div class="right">
            <span class="date">
                ${new Date(data.createdAt).toLocaleDateString("en-IN", {
                    ...
                    `
                ul.appendChild(li);
                const rightDiv = li.querySelector(".right");
                rightDiv.appendChild(delteBtn);
...
function render() {
    ...
    for (let i = 0; i < mixedData.length; i++) {
        ...
        if (currentFilter === "daily") {
            ...
            if (expenseDate < startOfDay || expenseDate > endOfDay) continue;
        }
